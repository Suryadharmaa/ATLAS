...
ONBOARDING_ID = (
    ...
    "Cara pakai:\n"
    "• /analyze BTC — analisa langsung\n"
    "• Atau ketik: _\"analisa BBCA\"_ atau _\"risk on ETH\"_\n\n"
...
ONBOARDING_EN = (
    ...
    "How to use:\n"
    "• /analyze BTC — direct analysis\n"
    "• Or type: _\"analyze BBCA\"_ or _\"risk on ETH\"_\n\n"
    "⚠️ All output is educational. Not investment advice."
)

HELP_ID = (
    "*ATLAS — Bantuan*\n\n"
    "• /analyze [ticker] — analisa market\n"
    "• /disclaimer — tampilkan disclaimer lengkap\n"
    "• /start — reset sesi\n\n"
    "Contoh: /analyze BTC, /analyze BBCA"
)
...
HELP_EN = (
    ...
    "• /start — reset session\n\n"
    "Examples: /analyze BTC, /analyze AAPL"
)
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not ticker:
        clarification = (
            "Kamu ingin analisa aset apa? Contoh: BTC, BBCA, ETH, GOTO.\n"
...
async def _process_analysis(
    ...
    # Run analysis
    result = run_analysis(user_text, session["history"], lang)
...
def main():
    ...
    logger.info("ATLAS v1 bot started.")
    app.run_polling()
