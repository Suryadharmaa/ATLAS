...
2. Bias dinyatakan KUAT hanya jika >= 3 faktor data mendukung.
3. Skenario alternatif wajib memiliki kondisi invalidasi spesifik.
4. Risiko harus bersumber dari BEAR case yang diterima.
...
3. Alternative scenario must include a specific invalidation condition.
4. Risks must draw from the BEAR case received.
